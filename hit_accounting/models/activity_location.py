...
class ActivityLocation(models.Model):
    ...
    location_department_ids = fields.One2many(
        'hit.activity.location.department', 'activity_location_id', string='Location Department')
    location_id = fields.Many2one('hit.location', string='Location')
...
class ActivitylocationDepartment(models.Model):
    _name = 'hit.activity.location.department'
    ...
    department_id = fields.Many2one('hit.department', string='Department')

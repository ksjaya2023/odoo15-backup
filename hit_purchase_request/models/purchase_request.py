...
class PurchaseRequest(models.Model):
    ...
    many2one_field_y7F5a = fields.Many2one(comodel_name='purchase.order', string='Purchase Order')
    # many2one_reservation = fields.Many2one(comodel_name='x_reservation', string='Reservation')
    ...
    request_type = fields.Selection(tring='Request Type',
